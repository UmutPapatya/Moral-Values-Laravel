                        ...
                        <div class="bd-example bd-example-tabs">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade active show embed-responsive embed-responsive-16by9" id="pills-video1" role="tabpanel" aria-labelledby="pills-video1-tab">
                                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/gKZZLlkfTDw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    <br> <br>
                                ...
                                <div class="tab-pane fade embed-responsive embed-responsive-16by9" id="pills-video2" role="tabpanel" aria-labelledby="pills-video2-tab">
                                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/F_F8vTUApHk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    <div class="d-flex flex-wrap align-items-end mb-16pt">
                                        <h2 class="text-white flex m-0">Moral of the Video</h2>
                                    </div>
