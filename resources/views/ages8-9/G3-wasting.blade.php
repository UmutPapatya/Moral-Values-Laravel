...
@section('content')
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                        ...
                                        <div class="js-player embed-responsive embed-responsive-16by9 mb-32pt" >
                                            <div class="player embed-responsive-item">
                                                <div class="player__embed">
                                                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/o0bNx-Ea_B4" allowfullscreen=""></iframe>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="pills-video2">
                                        <div class="js-player embed-responsive embed-responsive-16by9 mb-32pt">
                                            <div class="player embed-responsive-item">
                                                <div class="player__embed">
                                                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/rl0YiZjTqpw" allowfullscreen=""></iframe>
                                                </div>
                                            </div>
                                        </div>
                                    <!--     <div class="d-flex flex-wrap align-items-end mb-16pt">
     ...
     <div class="pb-lg-64pt py-32pt">
        <div class="container page__container">
            <div class="d-flex flex-wrap align-items-end mb-16pt">
                <h2 class="text-dark flex m-0">Stories about Wasting</h2>
            </div>
            <div class="bd-example bd-example-tabs">
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade active show" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        <div class="d-flex flex-column flex-sm-row align-items-center justify-content-start">
                            <p>
                                Sonu is a darling boy. He loves to read books and play with his favorite toys. He is the dearest son to his mom and he loves his mother a lot. He is a gentle and obedient child. But the only problem with Sonu is he doesn't like food. Whatever food is offered to him, he eats very little and throws the rest.<br>
                                Day by Day, Sonu's mother got very tense about his eating habits. She discussed this problem with her friend. Her friend suggested teaching him the importance of food. Sonu's mother thought it was a very good idea.<br>

                                The very next day, Sonu's mother asked him to take a fistful of rice and pour it into a pot and then go for dinner. He did it as his mother said and went for dinner. This repeated every day and soon, daily it became a regular habit for Sonu to pour a fistful of rice in the pot before dinner.<br>
                                After a month of regular pouring, the pot became full of rice. The mother decided to cook vegetable rice and asked Sonu to help him prepare the food. Sonu and his mother happily prepared food while Sonu also learned how to cook food. After that, they both set forth to a street with food, where there are poor kids. <br>

                                Sonu's mother asked Sonu to offer food to the kids. The kids felt very happy and ate completely as it was very delicious. Sonu felt very happy watching this and got tears in his eyes.<br>

                                After returning home, Sonu said, " Mother, now I got to know the value of food. The food we waste is very precious for the one who does not have it. Now I'll never throw food and will never hurt you. Also, I got to know the importance of offering food to others and the happiness in it ". By listening to these words, the mother felt very happy and hugged her Son. She happily thanked her dear friend for this suggestion in her mind.<br>
                            </p>
                        </div>
                        <div class="d-flex flex-wrap align-items-end mb-16pt">
                        ...
                        <div class="d-flex flex-column flex-sm-row align-items-center justify-content-start">
                            <p class="hero__lead measure-hero-lead text-dark mb-24pt">
                                Never waste food. The food we waste may be precious for needy people.                            </p>
                        </div>                               
                    </div>
